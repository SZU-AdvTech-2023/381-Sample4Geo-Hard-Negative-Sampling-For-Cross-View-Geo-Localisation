...
df_train = pd.read_csv('/hong614/dataset/CVUSA/splits/train-19zl.csv', header=None)
...
df_gps = pd.read_csv('/hong614/dataset/CVUSA/split_locations/all.csv', header=None)
...
print("Saving...") 
with open("/hong614/dataset/CVUSA/gps_dict.pkl", "wb") as f:
