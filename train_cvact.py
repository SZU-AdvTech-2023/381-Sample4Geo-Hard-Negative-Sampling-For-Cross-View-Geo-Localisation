...
class Configuration:
    ...
    verbose: bool = True
    gpu_ids: tuple = (2,3)     # GPU ids for training
    ...
    gps_dict_path: str = "/home/liyiru/data/ANU_data_small/gps_dict.pkl"   # path to pre-computed distances
...
if __name__ == '__main__':
    ...
    pretrained_cfg_overlay = {'file' : r"/home/liyiru/.cache/torch/hub/checkpoints/pytorch_model.bin"}
    ...
    # Transforms
    sat_transforms_train, ground_transforms_train = get_transforms_train(config.fov, image_size_sat,
                                                                   img_size_ground,
                                                                   mean=mean,
                                                                   std=std,
                                                                   )
    ...
    # Train
    train_dataset = CVACTDatasetTrain(fov = config.fov, data_folder=config.data_folder ,
    ...
    # Eval
    sat_transforms_val, ground_transforms_val = get_transforms_val(config.fov, image_size_sat,
                                                               img_size_ground,
                                                               mean=mean,
                                                               std=std,
                                                               )
    ...
    reference_dataset_val = CVACTDatasetEval(fov = config.fov, data_folder=config.data_folder ,
                                             split="val",
                                             img_type="reference",
    ...
    query_dataset_val = CVACTDatasetEval(fov = config.fov, data_folder=config.data_folder ,
                                         split="val",
                                         img_type="query",    
    ...
    if config.sim_sample:
        ...
        query_dataset_train = CVACTDatasetEval(fov = config.fov, data_folder=config.data_folder ,
                                               split="train",
                                               img_type="query",   
                                               transforms=ground_transforms_val,
                                               )
        ...
        reference_dataset_train = CVACTDatasetEval(fov = config.fov, data_folder=config.data_folder ,
                                                   split="train",
                                                   img_type="reference", 
                                                   transforms=sat_transforms_val,
                                                   )
