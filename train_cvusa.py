...
class Configuration:
    ...
    # Dataset
    data_folder = "/home/liyiru/data/Polar_CVUSA"     
...
if __name__ == '__main__':
    ...
    #print(timm.models.create_model('deit_small_distilled_patch16_224').default_cfg)
    ...
    # Train
    train_dataset = CVUSADatasetTrain(fov = config.fov, data_folder=config.data_folder ,
    ...
    reference_dataset_test = CVUSADatasetEval(fov = config.fov, data_folder=config.data_folder ,
                                              split="test",
                                              img_type="reference",
    ...
    query_dataset_test = CVUSADatasetEval(fov = config.fov, data_folder=config.data_folder ,
                                          split="test",
                                          img_type="query",    
    ...
    if config.sim_sample:
        ...
        query_dataset_train = CVUSADatasetEval(fov = config.fov, data_folder=config.data_folder ,
                                               split="train",
                                               img_type="query",   
                                               transforms=ground_transforms_val,
                                               )
        ...
        reference_dataset_train = CVUSADatasetEval(fov = config.fov,data_folder=config.data_folder ,
                                                   split="train",
                                                   img_type="reference", 
                                                   transforms=sat_transforms_val,
                                                   )
